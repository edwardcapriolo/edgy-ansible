...
/opt/hadoop/bin/hadoop jar  /opt/hadoop/bin/yarn jar ./share/hadoop/mapreduce/hadoop-mapreduce-examples-3.4.2.jar wordcount hdfs://nn1/user/auser/in hdfs://nn1/user/auser/out  ;
